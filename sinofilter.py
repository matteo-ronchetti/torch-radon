...
X = nn.Parameter(torch.Tensor(16, 8, 256, 256).normal_().to(device), requires_grad=True)
W = nn.Parameter(torch.Tensor(8, 256, 256).normal_().to(device), requires_grad=True)
